...
const themes: Record<string, TemplateTheme> = {
  ...
  "garden-luxe": {
    ...
    heroLayout: "overlay",
    headingFont: "var(--font-cormorant)",
    shellClass: "bg-[radial-gradient(circle_at_top,#f8fdf8_0%,#eef7ef_45%,#e2efe4_100%)]",
    frameClass: "border-emerald-100/85 bg-[#f8fdf9]/80",
    navClass: "border-emerald-200/60 bg-[#eaf7ee]/70 text-[#3e6f54]",
    contentCardClass: "border-emerald-100/80 bg-white/88",
    sidebarCardClass: "border-emerald-200/70 bg-[#f1fbf4]/85",
    heroImage: "https://images.unsplash.com/photo-1520854221256-17451cc331bf?w=1800&q=80&auto=format&fit=crop",
    heroOverlay: "bg-[linear-gradient(to_bottom,rgba(26,88,63,.16),rgba(26,88,63,.5))]",
    heroRightBgClass: "bg-[linear-gradient(165deg,#f8fdf8_0%,#ebf7ee_45%,#f7fcf8_100%)]",
    heroCardClass: "border-[#cbe3d1] bg-white/95",
    heroBadgeClass: "border-[#bbd8c3] text-[#4b775d]",
    heroDividerClass: "from-transparent via-[#89b79a] to-transparent",
    heroNameGradient: "linear-gradient(178deg,#9fd3af 0%,#5fa277 52%,#2f6c4d 100%)",
    heroNameShadow: "0 6px 18px rgba(47,108,77,.2)",
    heroDateClass: "text-[#528c69]",
    statBoxClass: "border-[#cbe3d1] bg-white",
    ctaClass: "bg-[linear-gradient(110deg,#2f6c4d,#4f9369,#74b383)] text-white shadow-[0_16px_30px_-16px_rgba(47,108,77,.58)]",
    titleClass: "text-[#2f5f45]",
    mutedClass: "text-[#5b7b69]",
    accent: "#4f9369",
  },
  "sunset-terracotta": {
    key: "sunset-terracotta",
    heroLayout: "split",
    headingFont: "var(--font-playfair)",
    shellClass: "bg-[radial-gradient(circle_at_top,#fff8f3_0%,#f8ece4_45%,#efdacb_100%)]",
    frameClass: "border-orange-100/85 bg-[#fff8f3]/82",
    navClass: "border-orange-200/60 bg-[#fdeedf]/72 text-[#8e5232]",
    contentCardClass: "border-orange-100/80 bg-white/88",
    sidebarCardClass: "border-orange-200/70 bg-[#fff2e9]/86",
    heroImage: "https://images.unsplash.com/photo-1529636798458-92182e662485?w=1800&q=80&auto=format&fit=crop",
    heroOverlay: "bg-[linear-gradient(to_bottom,rgba(128,73,41,.14),rgba(128,73,41,.52))]",
    heroRightBgClass: "bg-[linear-gradient(165deg,#fffaf5_0%,#faeee5_45%,#fff7f1_100%)]",
    heroCardClass: "border-[#e7cdbd] bg-white/95",
    heroBadgeClass: "border-[#ddc0ad] text-[#8d664f]",
    heroDividerClass: "from-transparent via-[#cf9a7b] to-transparent",
    heroNameGradient: "linear-gradient(178deg,#e8b08e 0%,#bf7448 52%,#8f4f2f 100%)",
    heroNameShadow: "0 6px 20px rgba(143,79,47,.2)",
    heroDateClass: "text-[#b46f48]",
    statBoxClass: "border-[#e9d1c3] bg-white",
    ctaClass: "bg-[linear-gradient(110deg,#8f4f2f,#b3673f,#d48b5b)] text-white shadow-[0_16px_30px_-16px_rgba(143,79,47,.6)]",
    titleClass: "text-[#6f3d24]",
    mutedClass: "text-[#8c6a57]",
    accent: "#b3673f",
  },
  "pearl-rose": {
    key: "pearl-rose",
    heroLayout: "editorial",
    headingFont: "var(--font-cormorant)",
    shellClass: "bg-[radial-gradient(circle_at_top,#fffafa_0%,#fdf1f4_45%,#f7e5eb_100%)]",
    frameClass: "border-pink-100/85 bg-[#fff9fb]/82",
    navClass: "border-pink-200/60 bg-[#fdeef3]/72 text-[#8a5870]",
    contentCardClass: "border-pink-100/80 bg-white/88",
    sidebarCardClass: "border-pink-200/70 bg-[#fff2f6]/86",
    heroImage: "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=1800&q=80&auto=format&fit=crop",
    heroOverlay: "bg-[linear-gradient(to_bottom,rgba(128,72,97,.18),rgba(128,72,97,.5))]",
    heroRightBgClass: "bg-[linear-gradient(165deg,#fffbfc_0%,#fdf0f4_45%,#fff9fb_100%)]",
    heroCardClass: "border-[#ebd2dc] bg-white/95",
    heroBadgeClass: "border-[#e2c2cf] text-[#8c5b70]",
    heroDividerClass: "from-transparent via-[#d99bb5] to-transparent",
    heroNameGradient: "linear-gradient(178deg,#f0bfd3 0%,#cf7fa1 52%,#9d4f72 100%)",
    heroNameShadow: "0 6px 20px rgba(157,79,114,.2)",
    heroDateClass: "text-[#bb6f92]",
    statBoxClass: "border-[#ebd2dc] bg-white",
    ctaClass: "bg-[linear-gradient(110deg,#9d4f72,#be6b90,#de93b5)] text-white shadow-[0_16px_30px_-16px_rgba(157,79,114,.6)]",
    titleClass: "text-[#7f4560]",
    mutedClass: "text-[#9a7082]",
    accent: "#be6b90",
  },
  "opal-night": {
    key: "opal-night",
    heroLayout: "editorial",
    headingFont: "var(--font-playfair)",
    shellClass: "bg-[radial-gradient(circle_at_top,#1a2433_0%,#121a27_45%,#0a1018_100%)]",
    frameClass: "border-slate-300/20 bg-[#0e1420]/78",
    navClass: "border-slate-300/25 bg-[#111a29]/70 text-slate-100",
    contentCardClass: "border-slate-300/20 bg-[#111a2a]/82",
    sidebarCardClass: "border-slate-300/30 bg-[#151f31]/85",
    heroImage: "https://images.unsplash.com/photo-1519741497674-611481863552?w=1800&q=80&auto=format&fit=crop",
    heroOverlay: "bg-[linear-gradient(to_bottom,rgba(0,0,0,.26),rgba(0,0,0,.7))]",
    heroRightBgClass: "bg-[linear-gradient(165deg,#141d2d_0%,#1a2435_45%,#131b2a_100%)]",
    heroCardClass: "border-slate-200/22 bg-[#0e1624]/82",
    heroBadgeClass: "border-slate-200/28 text-slate-100",
    heroDividerClass: "from-transparent via-[#86a8d6] to-transparent",
    heroNameGradient: "linear-gradient(178deg,#d2e2fb 0%,#8fb1de 52%,#5f85b5 100%)",
    heroNameShadow: "0 8px 24px rgba(0,0,0,.45)",
    heroDateClass: "text-slate-200",
    statBoxClass: "border-slate-200/25 bg-[#111b2c]",
    ctaClass: "bg-[linear-gradient(110deg,#4f6f97,#6b8db8,#89a8d0)] text-white shadow-[0_16px_30px_-16px_rgba(0,0,0,.7)]",
    titleClass: "text-slate-100",
    mutedClass: "text-slate-300/80",
    accent: "#6b8db8",
  },
};
