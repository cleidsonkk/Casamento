...
const themes: Record<string, TemplateTheme> = {
  ...
  "black-gold": {
    ...
    heroCardClass: "border-amber-300/35 bg-black/65",
    ...
    heroDateClass: "text-amber-200/85",
    statBoxClass: "border-amber-300/30 bg-black/55",
  ...
  "destination-beach": {
    ...
    heroRightBgClass: "bg-[linear-gradient(165deg,#f5fcff_0%,#e6f6fd_45%,#f8fdff_100%)]",
    heroCardClass: "border-[#cbe5f3] bg-white/90",
    heroBadgeClass: "border-[#bfdbeb] text-[#3a748f]",
    heroDividerClass: "from-transparent via-[#68b8de] to-transparent",
    heroNameGradient: "linear-gradient(178deg,#9ed8f3 0%,#4ea9d4 52%,#2f7ea5 100%)",
    heroNameShadow: "0 6px 18px rgba(63,139,179,.22)",
    heroDateClass: "text-[#4d99bf]",
    statBoxClass: "border-[#cfe6f2] bg-white",
